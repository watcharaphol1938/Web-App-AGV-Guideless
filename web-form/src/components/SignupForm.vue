<template>
  <div>
    <form @submit.prevent="handleSubmit">
      ...
      <!-- press Alt + a key is defined ,example >> ALT + , -->
      ...
      <!-- <div>
        <input type="checkbox" value="Flodo" v-model="names">
        <label>Flodo</label>
      </div>
      <div>
        <input type="checkbox" value="Pippins" v-model="names">
        <label>Pippins</label>
      </div>
      <div>
...
export default {
  ...
  methods: {
    ...
    handleSubmit() {
        ...
        // validate password
        this.passwordError = this.password.length > 5 ? '' : 'password must be at least 7 chars long'
